        ...
        {projectData ? (
          projectData.map(project => (
            <div key={project.project_name}>
              <div className="hidden md:block max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:shadow-xl">
                <div>
